...
import layout.BulananFragment;
import layout.DompetFragment;
import layout.HarianFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    private void bulananFragment(){
        fm = getFragmentManager();
        ft = fm.beginTransaction();

        BulananFragment a = new BulananFragment();
        ft.replace(R.id.frame_content, a);
        ft.commit();
    }

    private void harianFragment(){
        fm = getFragmentManager();
        ft = fm.beginTransaction();

        HarianFragment a = new HarianFragment();
        ft.replace(R.id.frame_content, a);
        ft.commit();
    }
